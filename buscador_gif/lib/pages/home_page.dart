import 'dart:convert';
import 'package:buscador_gif/pages/gifs_page.dart';
        ...
        itemBuilder: (context, index) {
          if (_search == null || _search.isEmpty || index < snapshot.data["data"].length)
            return GestureDetector(
              child: FadeInImage.memoryNetwork(  // para abrir mais suave os gifs
                placeholder: kTransparentImage,  // fica uma imagem transparente até carregar
